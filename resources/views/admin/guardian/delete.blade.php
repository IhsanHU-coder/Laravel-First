            ...
            <div class="flex justify-center items-center space-x-4">
                ...
                <button
                    ...
                    class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 
                           hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 
                           dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:bg-gray-600"
                >
                    No, cancel
                </button>
                ...
                <form :action="deleteUrl" method="POST">
                    ...
                    <button
                        type="submit"
                        class="py-2 px-3 text-sm font-medium text-center text-white 
